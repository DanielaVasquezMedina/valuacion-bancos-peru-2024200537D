...
- Yahoo Finance mediante la librería yfinance (precios diarios de BBVAC1, CREDITC1, SCOTIAC1 e INTERBC1).
- Superintendencia de Banca, Seguros y AFP (SBS): cuadros B-2201, B-2401 y B-2402 de banca múltiple, mediante descarga programática.
